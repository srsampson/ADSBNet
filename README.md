#### ADSNet
This server listens on a TCP port for Basestation compatible data (127.0.0.1 Port 30003 by default). I've been working with modesdeco2 with an RTL SDR and modesmixer2 with beast-splitter and a Mode-S Beast receiver.
